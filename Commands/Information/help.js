...
const await = require('discord.js');

module.exports = {
    data: new SlashCommandBuilder()
    .setName("help")
    .setDescription("Gets a list of all the commands!")
    ...
    async execute(interaction) {
        ...
        const categories = directories.map((dir) => {
            ...
            .map((cmd) => {
                return {
                    name: cmd.data.name,
                    description: cmd.data.description || "There is no any description for this command.",
                };
            });

            const embed = new EmbedBuilder()
            .setDescription("See all the commands by selecting the category down below!")
            .setColor('#33FFDB')
            ...
            collector.on("collect", (interaction) => {
                ...
                .setDescription(`A list of all the commands under ${directory}.`)
                .setColor("#33FFDB")
                .addFields(
